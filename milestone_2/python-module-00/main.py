...
This main.py is at the root level and can test exercises from all directories.
"""
...
def test_ft_exercise(exercise_file_name, choice="a"):
    """
    ...
    try:
        ...
        sys.path.insert(0, f"ex{choice if choice != 'a' else dict(zip(['ft_hello_garden','ft_plot_area','ft_harvest_total','ft_plant_age','ft_water_reminder','ft_count_harvest_iterative','ft_count_harvest_recursive','ft_garden_summary','ft_seed_inventory'],['0','1','2','3','4','5','5','6','7'])).get(exercise_file_name,'0')}"); ft_module = __import__(exercise_file_name)
